...
import { mockFilterExampleFields } from "../mocks/mockFilterExample";
import { mockSortFields } from "../mocks/mockSortExample";


export default class DocumentToolbar extends React.Component {
  state = {
